...
class MysqlExport(
    ...
    fun createMysql(): DataSource {
        ...
        dataSource.url = normalizeUrl(env.getProperty("export.mysql.url", "jdbc:mysql://localhost:3306/moonbeam")) + "?" + params

        dataSource.username = env.getProperty("export.mysql.username", "moonbeam")
