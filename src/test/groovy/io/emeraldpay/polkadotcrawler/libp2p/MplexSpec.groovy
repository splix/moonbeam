...
class MplexSpec extends Specification {
    ...
    def "Parse single packets"() {
        ...
        with(act[0]) {
            ...
            header.id == 1001
            DebugCommons.toHex(content()) == "132f6d756c746973747265616d2f312e302e300a"
        }
    }
    ...
    def "Parse two packets"() {
        ...
        with(act[0]) {
            header.flag == Mplex.Flag.MessageReceiver
            header.id == 1001
            DebugCommons.toHex(content()) == "0f2f697066732f69642f312e302e300a"
        }
        with(act[1]) {
            header.flag == Mplex.Flag.MessageReceiver
            header.id == 1001
            DebugCommons.toHex(content()) == ""
        }
    }
}
